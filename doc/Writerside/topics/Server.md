...
The server is the core of the game. It manages the game logic and the network.
...
RFC stands for Request For Comments. It is a document that describes a feature or a change to the game.

### Actual RFC for the Server

The RFC for the Server is :
