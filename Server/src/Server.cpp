...
namespace Exodia
{
    ...
    void Server::Init()
    {
        ...
        try
        {
            ...
            RegisterComponent( "Health", []( UNUSED( Buffer data ) ) -> IComponentContainer * {
                return new ComponentContainer<Health>();
            } );
            RegisterComponent( "Animation", []( UNUSED( Buffer data ) ) -> IComponentContainer * {
                return new ComponentContainer<Animation>();
            } );
            RegisterComponent( "Clock", []( UNUSED( Buffer data ) ) -> IComponentContainer * {
                return new ComponentContainer<Clock>();
            } );
