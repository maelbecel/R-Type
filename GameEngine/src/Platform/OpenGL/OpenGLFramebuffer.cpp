...
namespace Exodia {
    ...
    OpenGLFramebuffer::OpenGLFramebuffer(const FramebufferSpecification &spec) : _RendererID(0), _Specification(spec), _DepthAttachmentSpecification(FramebufferTextureFormat::None)
    {
    ...
    void OpenGLFramebuffer::ClearAttachment(uint32_t attachmentIndex, int value)
    {
        ...
        glClearTexImage(_ColorAttachments[attachmentIndex], 0, Utils::ExodiaFBTextureFormatToGL(spec.TextureFormat), GL_INT, &value);
    }
    ...
    void OpenGLFramebuffer::Invalidate()
    {
        ...
        EXODIA_CORE_ASSERT(glCheckFramebufferStatus(GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE, "Framebuffer is incomplete !");
