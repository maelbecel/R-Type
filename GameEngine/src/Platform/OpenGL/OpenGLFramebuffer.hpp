...
namespace Exodia {
    ...
    class OpenGLFramebuffer : public Framebuffer {
        ...
        private:
             ...
             * This function creates or recreates the color and depth attachments of the OpenGL framebuffer, based on the specifications provided during framebuffer creation.
             * It ensures that the framebuffer is complete and ready for rendering.
             * 
        ...
        private:
            ...
            std::vector<FramebufferTextureSpecification> _ColorAttachmentSpecifications; /* !< The specifications of the color attachment of the framebuffer. */
            FramebufferTextureSpecification              _DepthAttachmentSpecification;  /* !< The specification of the depth attachment of the framebuffer. */
