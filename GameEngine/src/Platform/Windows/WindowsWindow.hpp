...
namespace Exodia
{
    ...
    typedef struct WindowData_t
    {
        ...
        bool VSync; /* !< The VSync state that indicates whether Vertical Synchronization (V-Sync) is enabled for the
                       window. */
        std::function<void( Event & )> EventCallback; /* !< The event callback that will be invoked when events occur in
                                                         the window, with an Event parameter passed to it. */
    } WindowData;
    ...
    class WindowsWindow : public Window
    {
      ...
      public:
         ...
         *
         * @param props (Type: const WindowProps &): The window properties containing details about the window's initial
         * settings.
         */
         ...
         * This destructor is called when the WindowsWindow object is being destroyed, allowing for proper cleanup and
         * resource release.
         */
      ...
      private:
         ...
         * This method is called to initialize the window with the provided properties. It sets up the window's
         * graphical context and other initial settings.
      ...
      public:
         ...
         *
         * @param callback (Type: const std::function<void(Event &)> &): The callback function that takes an Event
         ...
         * This method is used to retrieve the native window pointer associated with the WindowsWindow object. This
         * pointer is platform-specific and can be used for interoperability.
         *
