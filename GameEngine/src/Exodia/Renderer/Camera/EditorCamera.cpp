...
namespace Exodia
{
    ...
    EditorCamera::EditorCamera( float fov, float aspectRatio, float nearClip, float farClip )
        : _FOV( fov ), _AspectRatio( aspectRatio ), _NearClip( nearClip ), _FarClip( farClip ),
          _Position( glm::vec3( 0.0f ) ), _FocalPoint( glm::vec3( 0.0f ) ), _InitialMousePosition( glm::vec2( 0.0f ) ),
          _Distance( 10.0f ), _Pitch( 0.0f ), _Yaw( 0.0f ), _ViewportWidth( 1280 ), _ViewportHeight( 720 )
    {
        UpdateView();
    }
