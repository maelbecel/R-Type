...
namespace Exodia
{
    ...
    OrthographicCameraController::OrthographicCameraController( float aspectRatio, bool rotation )
        : _ZoomLevel( 1.0f ),
          _Bounds( { -aspectRatio * _ZoomLevel, aspectRatio * _ZoomLevel, -_ZoomLevel, _ZoomLevel } ),
          _Camera( _Bounds.Left, _Bounds.Right, _Bounds.Bottom, _Bounds.Top ), _AspectRatio( aspectRatio ),
          _Rotation( rotation ), _CameraPos( { 0.0f, 0.0f, 0.0f } ), _CameraRotation( 0.0f ),
          _CameraTranslationSpeed( 5.0f ), _CameraRotationSpeed( 180.0f ){};
...
#undef max
    ...
    float OrthographicCameraController::GetZoomLevel() const { return _ZoomLevel; }

    const OrthographicCameraBounds &OrthographicCameraController::GetBounds() const { return _Bounds; }
}; // namespace Exodia
