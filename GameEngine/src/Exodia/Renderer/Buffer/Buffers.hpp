...
namespace Exodia {
    ...
    /**
     * @brief This structure represents a buffer element with the shader data type, name, size, offset and normalized value.
     * These elements are used in BufferLayout to define the structure of vertex data within the buffer.
     */
