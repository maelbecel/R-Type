...
namespace Exodia {
     ...
     * It provides methods for creating vertex arrays, binding and unbinding them, as well as managing associated vertex and index buffers.
     */
    class VertexArray {
        ...
        public:
             ...
             *
             * @return (Type: const std::vector<Ref<VertexBuffer>> &) A constant reference to the vector of vertex buffer references.
             */
