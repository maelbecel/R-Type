...
namespace Exodia {
    ...
    class RendererAPI {
      ...
      public:
        /**
         * @brief Initialize the rendering API. This function sets up the necessary resources and environment for
         * rendering.
         */
        virtual void Init() = 0;

        /**
         * @brief Clear the rendering buffer. This function clears the rendering buffer to the previously set clear
         * color.
         */
      ...
      public:
        ...
        inline static void SetAPI(API api) { _API = api; }

        inline static bool IsGraphical() { return _IsGraphical; }

        inline static void SetGraphical(bool isGraphical) { _IsGraphical = isGraphical; }
