...
namespace Exodia::Key {
    ...
    inline static std::string KeyCodesToString(KeyCode key)
    {
        switch (key) {
            ...
            case KPSUBSTRACT: return "KPSUBSTRACT";
    ...
    inline static KeyCode StringToKeyCode(const std::string& key) {
        ...
        if (key == "APOSTROPHE") return APOSTROPHE;
        ...
        if (key == "Y") return Y;
        if (key == "Z") return Z;
        if (key == "LEFTBRACKET") return LEFTBRACKET;
        if (key == "BACKSLASH") return BACKSLASH;
        if (key == "RIGHTBRACKET") return RIGHTBRACKET;
        if (key == "GRAVEACCENT") return GRAVEACCENT;
        if (key == "WORLD1") return WORLD1;
        if (key == "WORLD2") return WORLD2;
        ...
        if (key == "F25") return F25;
        if (key == "KP0") return KP0;
        if (key == "KP1") return KP1;
        if (key == "KP2") return KP2;
        if (key == "KP3") return KP3;
        if (key == "KP4") return KP4;
        if (key == "KP5") return KP5;
        if (key == "KP6") return KP6;
        if (key == "KP7") return KP7;
        if (key == "KP8") return KP8;
        if (key == "KP9") return KP9;
        if (key == "KPDECIMAL") return KPDECIMAL;
        if (key == "KPDIVIDE") return KPDIVIDE;
        if (key == "KPMULTIPLY") return KPMULTIPLY;
        if (key == "KPSUBSTRACT") return KPSUBSTRACT;
        if (key == "KPADD") return KPADD;
        if (key == "KPENTER") return KPENTER;
        if (key == "KPEQUAL") return KPEQUAL;
        if (key == "LEFTSHIFT") return LEFTSHIFT;
        if (key == "LEFTCONTROL") return LEFTCONTROL;
        if (key == "LEFTALT") return LEFTALT;
        if (key == "LEFTSUPER") return LEFTSUPER;
        if (key == "RIGHTSHIFT") return RIGHTSHIFT;
        if (key == "RIGHTCONTROL") return RIGHTCONTROL;
        if (key == "RIGHTALT") return RIGHTALT;
        if (key == "RIGHTSUPER") return RIGHTSUPER;
