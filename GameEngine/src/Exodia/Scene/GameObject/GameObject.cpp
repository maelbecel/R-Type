...
namespace Exodia {
    ...
    GameObject::operator bool() const { return _EntityHandle != Entity::InvalidEntityID; }

    GameObject::operator uint32_t() const { return (uint32_t)_EntityHandle; }

    GameObject::operator Entity() const { return _EntityHandle; }
