...
namespace Exodia {
    ...
    void ParticleSystem::Update(World *world, Timestep ts) {
        world->ForEach<TransformComponent, RigidBody2DComponent, ParticleComponent, SpriteRendererComponent>(
            [&](Entity *entity, auto transform, auto rigidBody, auto particle, auto sprite) {
