    ...
    struct CameraComponent : public Component {
        ...
        Buffer SerializeData() override {
            try {
                ...
                std::memcpy(data.Data + sizeof(SceneCamera::ProjectionType) + sizeof(float), &perspectiveNearClip,
                            sizeof(float));
                std::memcpy(data.Data + sizeof(SceneCamera::ProjectionType) + sizeof(float) * 2, &perspectiveFarClip,
                            sizeof(float));
                std::memcpy(data.Data + sizeof(SceneCamera::ProjectionType) + sizeof(float) * 3, &orthographicSize,
                            sizeof(float));
                std::memcpy(data.Data + sizeof(SceneCamera::ProjectionType) + sizeof(float) * 4, &orthographicNearClip,
                            sizeof(float));
                std::memcpy(data.Data + sizeof(SceneCamera::ProjectionType) + sizeof(float) * 5, &orthographicFarClip,
                            sizeof(float));
                std::memcpy(data.Data + sizeof(SceneCamera::ProjectionType) + sizeof(float) * 6, &Primary,
                            sizeof(bool));
                std::memcpy(data.Data + sizeof(SceneCamera::ProjectionType) + sizeof(float) * 6 + sizeof(bool),
                            &FixedAspectRatio, sizeof(bool));
