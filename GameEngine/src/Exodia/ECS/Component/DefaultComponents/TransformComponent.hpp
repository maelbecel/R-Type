    ...
    struct TransformComponent : public Component {
        ...
        virtual void Deserialize(const YAML::Node &node) {
            try {
                ...
                Translation =
                    glm::vec3(transform["Translation"][0].as<float>(), transform["Translation"][1].as<float>(),
                              transform["Translation"][2].as<float>());
                Rotation = glm::vec3(transform["Rotation"][0].as<float>(), transform["Rotation"][1].as<float>(),
                                     transform["Rotation"][2].as<float>());
                Scale = glm::vec3(transform["Scale"][0].as<float>(), transform["Scale"][1].as<float>(),
                                  transform["Scale"][2].as<float>());
