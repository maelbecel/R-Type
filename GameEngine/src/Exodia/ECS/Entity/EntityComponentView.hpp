...
namespace Exodia {
    ...
    template <typename... Components> class EntityComponentView {

        /////////////////
        // Constructor //
        /////////////////
      public:
        EntityComponentView(const EntityComponentIterator<Components...> &first,
                            const EntityComponentIterator<Components...> &last)
            ...
            if (_FirstIterator.Get() == nullptr ||
                ...
                !_FirstIterator.Get()->template HasComponent<Components...>())
                ++_FirstIterator;
        }
        ...
        /////////////
      public:
        const EntityComponentIterator<Components...> &begin() const { return _FirstIterator; }

        const EntityComponentIterator<Components...> &end() const { return _LastIterator; }
