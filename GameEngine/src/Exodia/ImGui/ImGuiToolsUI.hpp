...
namespace Exodia {
    ...
    inline static void DrawVec2Control(const std::string &label, glm::vec2 &values, float resetValueX = 0.0f, float resetValueY = 0.0f, float columnWidth = 100.0f)
    {
