...
namespace Exodia {
    ...
    struct SpriteRendererComponent : public Component {
        ...
        virtual void DrawComponent() override {
            ...
            AssetHandle textureHandle = Texture ? Texture->GetAssetHandle() : AssetHandle(0);
            ...
            if (ImGui::BeginDragDropTarget()) {
                if (const ImGuiPayload *payload = ImGui::AcceptDragDropPayload("CONTENT_BROWSER_ITEM")) {
                    ...
                    if (AssetManager::GetAssetType(handle) == AssetType::Texture2D) {
                        ...
                        EXODIA_CORE_WARN("The asset '{0}' is not a Texture2D", (uint64_t)handle);
                }
            ...
            if (Texture) {
                ...
                DrawVec2Control("Cell Size", (glm::vec2 &)textureCellSize, (float)Texture->GetTexture()->GetWidth(),
                                (float)Texture->GetTexture()->GetHeight());
    ...
    struct TextRendererComponent : public Component {
        ...
        TextRendererComponent(const std::string &text = std::string(), const glm::vec4 &color = glm::vec4(1.0f))
            : Text(text), Color(color), Font(45121874124124), Kerning(0.0f), LineSpacing(0.0f){};
            ...
            if (ImGui::BeginDragDropTarget()) {
                if (const ImGuiPayload *payload = ImGui::AcceptDragDropPayload("CONTENT_BROWSER_ITEM")) {
                    ...
                    if (AssetManager::GetAssetType(handle) == AssetType::Font)
                        ...
                        EXODIA_CORE_WARN("The asset '{0}' is not a Font", (uint64_t)handle);
                }
                ImGui::EndDragDropTarget();
            }
        }
