...
namespace Exodia {
    ...
    Project::Project() {
        ...
        RegisterSystem("ParticleSystem", []() -> EntitySystem * { return new ParticleSystem(); });
    }
    ...
    std::unordered_map<std::string, std::function<ScriptableEntity *()>> &Project::GetScriptsFactory() {
    ...
    std::unordered_map<std::string, std::function<EntitySystem *()>> &Project::GetSystemsFactory() {
