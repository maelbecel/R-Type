    ...
    class PataPata : public ScriptableEntity
    {
      ...
      public:
        void CreateBullet( TransformComponent &tc )
        {
            ...
            Entity *bullet = HandleEntity->GetWorld()->CreateNewEntity(
                "BE" + std::to_string( HandleEntity->GetWorld()->GetCount() ) );
        ...
        void OnCreate() override
        {
            ...
            EXODIA_INFO( "PataPata created at pos {0}, {1}", transform.Get().Translation.x,
                         transform.Get().Translation.y );
        }
