...
namespace Exodia {
    ...
    void CreatePlayer(std::map<RType::SceneType, std::shared_ptr<Exodia::Scene>> _World, int playerID)
    {
        Entity *entity = _World[RType::SceneType::GAME]->CreateEntity("Player_" + std::to_string(playerID));
